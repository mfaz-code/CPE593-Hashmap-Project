...
int main(){
  ...
  std::cout << "    mapping (.addWord, .addPref, and .makeHashTable) benchmark duration for dictionary: " << duration.count() << " microseconds" << std::endl;
  ...
  std::cout << "    prefix search (trie traversal) benchmark duration for dictionary: " << duration.count() << " microseconds" << std::endl;
  start = std::chrono::high_resolution_clock::now();
  ...
  std::cout << "    word search (trie traversal and hash access) benchmark duration for dictionary: " << duration.count() << " microseconds" << std::endl;
  start = std::chrono::high_resolution_clock::now();
  ...
  std::cout << "    word add (pure trie mapping) benchmark duration for dictionary: " << duration.count() << " microseconds" << std::endl;
  start = std::chrono::high_resolution_clock::now();
  ...
  std::cout << "    word search (pure trie traversal) benchmark duration for dictionary: " << duration.count() << " microseconds" << std::endl;
  start = std::chrono::high_resolution_clock::now();
...
//  std::cout << "adding word ["<< word << "] in dictionary" << std::endl; //'parasyxx' doesn't exist. it's meant to test if the word will still hash.
  ...
  std::cout << "    word add (trie traversal and hash access) benchmark duration for dictionary: " << duration.count() << " microseconds" << std::endl;
  start = std::chrono::high_resolution_clock::now();
